...
export async function PUT(req, { params }) {
    ...
    const getMatchQuery = await sql`SELECT "player1Verified", "matchStatus", "groupId", "matchStage", "matchRound", "matchSequence", "winnerId", "loserId", "eventId" FROM Matches WHERE "matchId" = ${matchId}`;
